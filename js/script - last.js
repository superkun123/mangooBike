...
tl.from('.scooter-scale-img', .5, {scale:4, y:1300})
    ...
    var tween = TweenMax.to(obj, 10,
      {
        ...
        onComplete: function () {
          ...
          tl3.from('.how-it-works__phone', 30, {x:-250} )
            .to('.how-it-works__text__item-1', 30, {opacity:1, x:0})
            .to('.how-it-works__text__item-2', 30, {opacity:1, x:0})
            .to('.how-it-works__text__item-3', 30, {opacity:1, x:0})
            .to('.how-it-works__text', 30, {opacity:0})
            .to('.how-it-works__phone', 30, {x:0, x:-250})
            .to('.how-it-works__phone', 30, {scale:4, x:-0, opacity:0})
            .to('how-it-works', 30, {opacity:0});
